    ...
    <div class="ui container">
        ...
        <div class="ui top attached segment">
            <div class="ui middle aligned two column grid">
                <div class="column">
                    <h3 class="ui teal header">Blog管理</h3>
                </div>
                <div class="right aligned column">
                    <%

                        Optional<List<Input>> articleBackstage = (Optional<List<Input>>) request.getAttribute("articlesListBackStage");

                        if (articleBackstage != null && articleBackstage.isPresent()) {
                            List<Input> articles = articleBackstage.get();
                    %>
                    共<h2 class="ui orange header m-inline-block m-text-thin"><%=articles.size()%>
                </h2>个
                </div>
            </div>
        </div>
        ...
        <div class="ui attached segment">
            ...
            <div class="ui labeled button m-margin-tb">
                <a href="/backstage/original?flagOriginal=オリジナル" class="ui basic teal button">オリジナル</a>
        ...
        <table class="ui center aligned  table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/backstage/delete?id=<%=input.getId()%>" class="ui mini red basic button">删除</a>
                </td>
            </tr>
            <%
                    }
